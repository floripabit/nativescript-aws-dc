...
import { AccessToken, ErrorObject, IdToken, RefreshToken, UserDetails, UserSession } from "./cognito.common";
...
export class AwsDcCognito extends Common {
    ...
    public signUp(userId, password, attributes) {
        ...
        return new Promise<any>((resolve, reject) => {
            const callBack = new SignUpHandler({
                ...
                onFailure(exception) {
                    reject(AwsDcCognito.getErrorObject(exception));
                }
            });
    ...
    public confirmForgotPassword(userId, code, newPassword) {
        if (this.forgotContinue == null) {
            return new Promise<any>((resolve, reject) => {
                reject("Null forgotContinue");
            });
        }
        ...
        return new Promise<any>((resolve, reject) => {
            ...
            this.forgotFailure = e => reject(AwsDcCognito.getErrorObject(e));
        });
    }
